...
exports.acceptInvitation = exports.generateMockup = exports.generateUILayout = exports.testQuoteGeneration = exports.healthCheck = exports.generateBoltPrompt = exports.generateStatementOfWork = exports.generateQuote = exports.removeUser = exports.inviteUser = void 0;
...
const createGraphClient = async () => {
    ...
    const cca = new msal_node_1.ConfidentialClientApplication(clientConfig);
...
const sendEmailWithGraph = async (to, subject, htmlContent, fromEmail) => {
    try {
    ...
    corsHandler(request, response, async () => {
        ...
        try {
            ...
            const requestingUserDoc = await admin.firestore()
                ...
                .get();
            if (!requestingUserDoc.exists || ((_a = requestingUserDoc.data()) === null || _a === void 0 ? void 0 : _a.role) !== 'admin') {
                response.status(403).json({ error: 'Admin access required' });
                return;
            }
            const { email, role, companyId } = request.body;
            if (!email || !role) {
            ...
            const invitationData = {
                ...
                invitedByName: ((_b = requestingUserDoc.data()) === null || _b === void 0 ? void 0 : _b.name) || 'Admin',
                companyId: companyId || ((_c = requestingUserDoc.data()) === null || _c === void 0 ? void 0 : _c.companyId),
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <p>Hello,</p>
          <p>${((_d = requestingUserDoc.data()) === null || _d === void 0 ? void 0 : _d.name) || 'An admin'} has invited you to join their team on Insytify CRM.</p>
...
exports.generateQuote = functions.https.onRequest((request, response) => {
    corsHandler(request, response, async () => {
        var _a, _b, _c;
        try {
            // Only allow POST requests
            ...
            const { companyName, projectDescription, hourlyRate = 100 } = request.body;
      ...
      `;
            ...
            const openai = new openai_1.default({
                apiKey: process.env.OPENAI_API_KEY || ((_a = functions.config().openai) === null || _a === void 0 ? void 0 : _a.key),
            });
            ...
            quoteData.ScopeOfWork = quoteData.ScopeOfWork.map(item => (Object.assign(Object.assign({}, item), { EstimatedHours: Number(item.EstimatedHours) || 0, EstimatedCost: Number(item.EstimatedCost) || 0 })));
...
exports.generateStatementOfWork = functions.https.onRequest((request, response) => {
    corsHandler(request, response, async () => {
        var _a, _b, _c;
        try {
            // Only allow POST requests
            ...
            // Validate request body
            const { companyName, projectDescription, industry, targetAudience, model: requestedModel } = request.body;
            if (!companyName || !projectDescription) {
                response.status(400).json({
                    error: 'Missing required fields: companyName and projectDescription'
                });
      ...
      `;
            ...
            const openai = new openai_1.default({
                apiKey: process.env.OPENROUTER_API_KEY || process.env.OPENAI_API_KEY || ((_a = functions.config().openai) === null || _a === void 0 ? void 0 : _a.key),
...
exports.generateBoltPrompt = functions.https.onRequest((request, response) => {
    corsHandler(request, response, async () => {
        var _a, _b, _c;
        try {
            // Only allow POST requests
            ...
            // Validate request body
            const { quoteResponse, companyName, additionalContext } = request.body;
...
Please create a comprehensive Bolt.New prompt that covers all the features and requirements outlined in the quote.`;
            ...
            const generatedPrompt = (_c = (_b = completion.choices[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content;
            if (!generatedPrompt) {
                throw new Error('No response from OpenAI');
            }
            // Log successful generation
...
exports.testQuoteGeneration = functions.https.onRequest((request, response) => {
    corsHandler(request, response, async () => {
        try {
...
exports.generateUILayout = functions
    .runWith({
    timeoutSeconds: 540,
    memory: '1GB'
})
    ...
    corsHandler(request, response, async () => {
        ...
        try {
            ...
            const responseText = (_c = (_b = completion.choices[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content;
            if (!responseText)
            ...
            functions.logger.info('UI Layout generated successfully', {
                quoteId,
                screensCount: ((_d = uiLayout === null || uiLayout === void 0 ? void 0 : uiLayout.Components) === null || _d === void 0 ? void 0 : _d.length) || 0
            });
            response.status(200).json({
                success: true,
                uiLayout,
...
function buildUIPrompt(quoteData) {
...
exports.generateMockup = functions
    .runWith({
    timeoutSeconds: 300,
    memory: '2GB'
})
...
async function generateCustomizedHTML(templateHTML, quoteData, companyName) {
    var _a, _b, _c;
...
PROJECT FEATURES:
${quoteData.ScopeOfWork.map((feature, index) => `${index + 1}. ${feature.FeatureName}: ${feature.Description}`).join('\n')}
...
${templateHTML}`;
    ...
    const modifiedHTML = (_c = (_b = completion.choices[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content;
    if (!modifiedHTML) {
        throw new Error('No response from AI model');
    }
...
exports.acceptInvitation = functions.https.onRequest((request, response) => {
    corsHandler(request, response, async () => {
        try {
            // Only allow POST requests
            if (request.method !== 'POST') {
