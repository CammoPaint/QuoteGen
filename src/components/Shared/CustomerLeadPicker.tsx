  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div
        ...
        className={`
          w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-brand focus:border-transparent
          ...
          <div className="p-3 border-b border-gray-200">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-brand focus:border-transparent text-sm"
